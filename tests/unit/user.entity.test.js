...
describe("User Entity", () => {
  ...
  it("should throw an error if email is missing", () => {
    expect(() => new User("123", "Test User", null, "password123")).toThrow("User must have an email and password");
  });

  it("should throw an error if password is missing", () => {
    expect(() => new User("123", "Test User", "test@example.com", null)).toThrow("User must have an email and password");
  });
});
