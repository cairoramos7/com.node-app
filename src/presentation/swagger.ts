...
const options: swaggerJsdoc.Options = {
  ...
  // Look for files in both src and dist to handle dev and prod
  apis: ['./src/presentation/**/*.routes.ts', './src/presentation/**/*.controller.ts', './dist/presentation/**/*.routes.js', './dist/presentation/**/*.controller.js'],
};
